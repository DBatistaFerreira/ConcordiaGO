...
void main(){
 ...
 /* test('nextShuttleTimeTest', (){
  ...
  test('calculateArrivalTimeinStringFormat', (){
    expect(SchedulerService.instance.calculateArrivalTimeinStringFormat('2 mins'), SchedulerService.instance.calculateNewTime(SchedulerService.instance.stringTime(),2));
    expect(SchedulerService.instance.calculateArrivalTimeinStringFormat('2 hours 4 mins'), SchedulerService.instance.calculateNewTime(SchedulerService.instance.stringTime(),124));
    expect(SchedulerService.instance.calculateArrivalTimeinStringFormat('0 min'), SchedulerService.instance.calculateNewTime(SchedulerService.instance.stringTime(),0));
    expect(SchedulerService.instance.calculateArrivalTimeinStringFormat('8 hours 15 min'), SchedulerService.instance.calculateNewTime(SchedulerService.instance.stringTime(),495));
  });
