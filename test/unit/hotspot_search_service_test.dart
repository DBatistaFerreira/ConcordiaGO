...
void main() {
  final HotspotSearchService hotspotSearchService = HotspotSearchService
      .instance;
  final Map<String, Object> testMap = {
    ...
    'geometry' : {
      'location' :{
        'lat' : 45.4416251,
        'lng' : -73.88989309999999
      },
      'viewport' : {
        'northeast' : {
          'lat' : 45.44294377989272,
          'lng' : -73.88875132010726
        },
        'southwest': {
          'lat': 45.44024412010727,
          'lng': -73.89145097989271
        }
      }
    },
    ...
    'photos' : [
      {
        ...
        'photo_reference' : 'CmRaAAAA0TEer8AzwVeV1evhIFx2L8kuCXUC23rs78Gm-CSSU6Pq2hCAV5_GV0VFCv7S0I3jVC6r93cVpX4vF4ltJedChOfzDuEn0e1OVzQA0aRCSPpVEDeuP6TLKY-LByKVrqFAEhAv3Fw9VZEaYGZRDOL6_5IJGhS3CKqM3Y2nSGh3fsMpWDbN7OZysw',
        'width' : 2048,
      }
    ],
    'place_id' : 'ChIJ19vCaWE5yUwRIMYpTbsT0oU',
    'plus_code' : {
      'compound_code' : 'C4R6+M2 Kirkland, Quebec',
      'global_code' : '87Q8C4R6+M2'
    },
    'price_level' : 1,
    'rating' : 4.1,
  ...
  test('hotspotBuilder Test', () async {
    ...
    final Hotspot testHotspot = hotspotSearchService.hotspotBuilder(
    testMap, HotspotType.Restaurants);
