...
const Map<String, List<String>> availableIndoorFloors = <String, List<String>>{
  'H': <String>['1', '8', '9'],
  'MB': <String>['1', 'S2'],
  'CC': <String>['1'],
  'VE': <String>['1', '2'],
...
const Map<String, Map<String, List<int>>> nodeGraph = <String, Map<String, List<int>>>{
  'H1': <String, List<int>>{
    '000000': <int>[520, 460], // 0,
    '000001': <int>[520, 560], // 1,
    '000002': <int>[700, 560], // 2,
    '000003': <int>[895, 560], // 3,
    '000004': <int>[895, 760], // 4,
    '000005': <int>[970, 760], // 5,
    '000006': <int>[895, 826], // 6,
    '000007': <int>[746, 760], // 7,
    '000008': <int>[520, 760], // 8,
    '000009': <int>[520, 671], // 9,
    '000010': <int>[446, 760], // 10
    '000011': <int>[405, 677], // 11
    '000012': <int>[320, 760], // 12
    '000013': <int>[256, 710], // 13
    '000014': <int>[84, 676], // 14
    '990000': <int>[320, 828], // 15
    '990001': <int>[1003, 760], // 16
    '140000': <int>[84, 760], // 17
    '180000': <int>[574, 822], // 18
    '100110': <int>[256, 579], // 19
    '100112': <int>[460, 555], // 20
    '100114': <int>[465, 460], // 21
    '170000': <int>[895, 508], // 22
    '130000': <int>[700, 600], // 23
    '120000': <int>[697, 697], // 24
    '120001': <int>[697, 697], // 25
    '110000': <int>[697, 697], // 26
    '110001': <int>[775, 697], // 27
    '110002': <int>[775, 697], // 28
    '110003': <int>[775, 697], // 29
    '110004': <int>[802, 826], // 30
  },
  'H8': <String, List<int>>{
    '000000': <int>[176, 214], // 0,
    '000001': <int>[307, 214], // 1,
    '000002': <int>[342, 214], // 2,
    '000003': <int>[342, 120], // 3,
    '000004': <int>[463, 214], // 4,
    '000005': <int>[550, 214], // 5,
    '000006': <int>[638, 214], // 6,
    '000007': <int>[731, 214], // 7,
    '000008': <int>[837, 214], // 8,
    '000009': <int>[854, 169], // 9,
    '000010': <int>[837, 323], // 10
    '000011': <int>[837, 398], // 11
    '000012': <int>[837, 513], // 12
    '000013': <int>[837, 598], // hallFloors13
    '000014': <int>[837, 689], // 14
    '000015': <int>[837, 795], // 15
    '000016': <int>[878, 811], // 16
    '000017': <int>[730, 795], // 17
    '000018': <int>[641, 795], // 18
    '000019': <int>[641, 684], // 19
    '000020': <int>[550, 795], // 20
    '000021': <int>[462, 795], // 21
    '000022': <int>[400, 795], // 22
    '000023': <int>[400, 690], // 23
    '000024': <int>[368, 795], // 24
    '000025': <int>[282, 795], // 25
    '000026': <int>[176, 795], // 26
    '000027': <int>[90, 805], // 27
    '000028': <int>[176, 655], // 28
    '000029': <int>[176, 593], // 29
    '000030': <int>[176, 501], // 30
    '000031': <int>[176, 397], // 31
    '000032': <int>[176, 319], // 32
    '000033': <int>[132, 195], // 33
    '000034': <int>[132, 167], // 34
    '000035': <int>[264, 397], // 35
    '000036': <int>[264, 440], // 36
    '000037': <int>[264, 485], // 37
    '000038': <int>[264, 514], // 38
    '000039': <int>[368, 397], // 39
    '000040': <int>[479, 397], // 40
    '000041': <int>[550, 397], // 41
    '000042': <int>[550, 636], // 42
    '140000': <int>[550, 900], // 43
    '140001': <int>[550, 106], // 44
    '100801': <int>[176, 143], // 45
    '100802': <int>[307, 262], // 46
    '100803': <int>[307, 143], // 47
    '100805': <int>[342, 87], // 48
    '100807': <int>[463, 143], // 49
    '100810': <int>[638, 262], // 50
    '100811': <int>[638, 143], // 51
    '100813': <int>[731, 143], // 52
    '100815': <int>[854, 143], // 53
    '100817': <int>[898, 143], // 54
    '100819': <int>[898, 214], // 55
    '100820': <int>[638, 459], // 56
    '100821': <int>[898, 323], // 57
    '100822': <int>[773, 598], // 58
    '100823': <int>[898, 398], // 59
    '100825': <int>[898, 513], // 60
    '100827': <int>[898, 598], // 61
    '100829': <int>[898, 689], // 62
    '100831': <int>[878, 860], // 63
    '100832': <int>[641, 635], // 64
    '100833': <int>[837, 860], // 65
    '100835': <int>[730, 860], // 66
    '100837': <int>[641, 860], // 67
    '100841': <int>[462, 860], // 68
    '100842': <int>[400, 627], // 69
    '100843': <int>[368, 860], // 70
    '100845': <int>[282, 860], // 71
    '100847': <int>[176, 860], // 72
    '100849': <int>[90, 860], // 73
    '100851': <int>[90, 752], // 74
    '100852': <int>[219, 655], // 75
    '100853': <int>[110, 655], // 76
    '100854': <int>[233, 593], // 77
    '100855': <int>[110, 593], // 78
    '100857': <int>[110, 501], // 79
    '100859': <int>[110, 397], // 80
    '100861': <int>[110, 319], // 81
    '100862': <int>[368, 452], // 82
    '100863': <int>[110, 195], // 83
    '100865': <int>[106, 167], // 84
    '100867': <int>[132, 109], // 85
    '120000': <int>[480, 636], // 86
    '120001': <int>[479, 445], // 87
    '110000': <int>[305, 358], // 88 Top-left
    '110001': <int>[300, 742], // 89 Bottom-left
    '110002': <int>[715, 738], // 90 bottom-right
    '110003': <int>[712, 272], // 91 top-right
    '130000': <int>[356, 348], // 92
  },
  'H9': <String, List<int>>{
    '000000': <int>[181, 226], // 0,
    '000001': <int>[437, 226], // 1,
    '000002': <int>[532, 226], // 2,
    '000003': <int>[642, 226], // 3,
    '000004': <int>[720, 226], // 4,
    '000005': <int>[843, 226], // 5,
    '000006': <int>[860, 183], // 6,
    '000007': <int>[843, 336], // 7,
    '000008': <int>[843, 414], // 8,
    '000009': <int>[824, 532], // 9,
    '000010': <int>[870, 503], // 10
    '000011': <int>[801, 584], // 11
    '000012': <int>[815, 649], // 12
    '000013': <int>[827, 705], // 13
    '000014': <int>[827, 850], // 14
    '000015': <int>[707, 843], // 15
    '000016': <int>[666, 755], // 16
    '000017': <int>[716, 649], // 17
    '000018': <int>[666, 649], // 18
    '000019': <int>[569, 649], // 19
    '000020': <int>[532, 649], // 20
    '000021': <int>[478, 677], // 21
    '000022': <int>[407, 672], // 22
    '000023': <int>[404, 759], // 23
    '000024': <int>[404, 802], // 24
    '000025': <int>[404, 846], // 25
    '000026': <int>[382, 900], // 26
    '000027': <int>[82, 901], // 27
    '000028': <int>[80, 799], // 28
    '000029': <int>[83, 667], // 29
    '000030': <int>[83, 528], // 30
    '000031': <int>[299, 667], // 31
    '000032': <int>[521, 546], // 32
    '000033': <int>[531, 409], // 33
    '000034': <int>[457, 409], // 34
    '000035': <int>[362, 409], // 35
    '000036': <int>[273, 409], // 36
    '000037': <int>[182, 409], // 37
    '000038': <int>[179, 333], // 38
    '000039': <int>[531, 331], // 39
    '100902': <int>[437, 272], // 40
    '100903': <int>[181, 152], // 41
    '100907': <int>[437, 152], // 42
    '100909': <int>[532, 152], // 43
    '100910': <int>[642, 272], // 44
    '100911': <int>[642, 152], // 45
    '100913': <int>[720, 152], // 46
    '100914': <int>[489, 331], // 47
    '100915': <int>[860, 152], // 48
    '100917': <int>[912, 183], // 49
    '100919': <int>[912, 226], // 50
    '100920': <int>[642, 474], // 51
    '100921': <int>[912, 336], // 52
    '100923': <int>[912, 414], // 53
    '100925': <int>[912, 503], // 54
    '100927': <int>[912, 705], // 55
    '100928': <int>[797, 815], // 56
    '100929': <int>[887, 923], // 57
    '100933': <int>[787, 898], // 58
    '100937': <int>[594, 811], // 59
    '100941': <int>[416, 916], // 60
    '100943': <int>[365, 846], // 61
    '100945': <int>[365, 802], // 62
    '100961': <int>[121, 799], // 63
    '100962': <int>[362, 470], // 64
    '100963': <int>[182, 470], // 65
    '100964': <int>[273, 470], // 66
    '100965': <int>[112, 333], // 67
    '100966': <int>[407, 625], // 68
    '100967': <int>[112, 226], // 69
    '100968': <int>[299, 625], // 70
    '100980': <int>[569, 582], // 71
    '100981': <int>[367, 759], // 72
    '110000': <int>[273, 339], // 73
    '110001': <int>[299, 735], // 74
    '110002': <int>[716, 735], // 75
    '110003': <int>[720, 339], // 76
    '130000': <int>[362, 362], // 77
    '120000': <int>[457, 437], // 78
    '120001': <int>[465, 546], // 79
  },
  'MB1': <String, List<int>>{
    '000000': <int>[571, 951], // 0,
    '000001': <int>[576, 884], // 1,
    '000002': <int>[569, 834], // 2,
    '000003': <int>[725, 858], // 3,
    '000004': <int>[754, 848], // 4,
    '000005': <int>[894, 851], // 5,
    '000006': <int>[576, 609], // 6,
    '000007': <int>[489, 425], // 7,
    '000008': <int>[488, 225], // 8,
    '000009': <int>[470, 131], // 9,
    '000010': <int>[418, 172], // 10
    '000011': <int>[651, 232], // 11
    '990000': <int>[511, 957], // 12
    '990001': <int>[411, 121], // 13
    '100210': <int>[592, 424], // 14
    '170000': <int>[623, 826], // 15
    '150000': <int>[761, 793], // 16
    '120000': <int>[488, 822], // 17
    '120001': <int>[389, 200], // 18
    '120002': <int>[537, 506], // 19
    '140000': <int>[678, 924], // 20
    '140001': <int>[470, 595], // 21
    '140002': <int>[700, 605], // 22
  }
};

const Map<String, String> floorPlan = <String, String>{
